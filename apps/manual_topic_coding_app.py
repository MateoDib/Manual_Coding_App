...
BACKUP_DIR = APP_DIR / "backups_manual_topic_coding"

st.set_page_config(page_title="Manual Topic Coding", layout="wide")
...
with save_next_col:
    if st.button("Save and next"):
        ...
        save_private_workbook(df, WORKBOOK_PATH, BACKUP_DIR, st.session_state, "manual")
        st.cache_data.clear()
        next_index = min(row_index + 1, n_rows - 1)
